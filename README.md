...
**[To-Do-List is an application for adding new To-Do-List tasks by use of array of objects using ES6 and webpack.]**
...
```sh
  cd my-folder
  git clone https://github.com/cosywasswa/To-Do-List.git
```
